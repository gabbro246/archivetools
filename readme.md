...
Usage: ```bash python organizebydate.py --folder [target_folder] --[day|week|month|year] [--rename] [--mode mode]```
...
Usage: ```bash python flattenfolder.py --folder [target_folder] [--rename] [--depth n]```
...
Usage: ```bash python convertallfoldertozip.py --folder [target_folder]```
...
Usage: ```bash python convertallziptofolder.py --folder [target_folder]```
...
Usage: ```bash python deleteallduplicate.py --folder [target_folder] [--mode mode]```
...
Usage: ```bash python setdates.py --folder [target_folder] [--mode mode]```
